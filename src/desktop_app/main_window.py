...
3. Evita pujar cerca del precio de mercado (bajo margen)"""
    ...
    def _refresh_ml_predictions(self):
        ...
        try:
            from src.database.db_manager import DatabaseManager, Player, PriceHistory
...
⚡ 10x más rápido que actualización completa"""
    ...
    def _record_purchase(self, rec: Dict[str, Any]):
        ...
        try:
            ...
            try:
                from src.database.db_manager import Transaction, Player
    ...
    def _refresh_sell_recommendations(self):
        ...
        try:
            ...
            try:
                from src.database.db_manager import Transaction, Player, PriceHistory
    ...
    def _record_sale(self, card: Dict[str, Any]):
        ...
        try:
            ...
            try:
                from src.database.db_manager import Transaction
    ...
    def _connect_discord(self):
        ...
        try:
            from ..discord_bot.discord_notifier import DiscordNotifier
    ...
    def _get_price_comparison(self, player_id: str, current_price: int) -> Optional[Dict]:
        ...
        try:
            from src.database.db_manager import PriceHistory
            from datetime import datetime, timedelta
